...
$(".work-card").mouseover((function(){$(".work-card").removeClass("_active"),$(this).addClass("_active")})),$(".product-card__btn").click((function(){$(this).parents(".product-card").toggleClass("_open"),$(this).parents(".product-card").find(".product-card__content").slideToggle()})),$(".benefit-card").click((function(){$(this).hasClass("_active")?($(".benefit-card").removeClass("_active"),$(".benefit-card__hidden").slideUp()):($(".benefit-card").removeClass("_active"),$(".benefit-card__hidden").slideUp(),$(this).addClass("_active"),$(this).find(".benefit-card__hidden").slideDown())}));
